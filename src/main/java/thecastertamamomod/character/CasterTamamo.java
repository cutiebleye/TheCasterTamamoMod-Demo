...
import thecastertamamomod.cards.*;
import thecastertamamomod.powers.ManaPower;
import thecastertamamomod.relics.TamamoStartingRelic;

import java.util.ArrayList;

import static thecastertamamomod.BasicMod.characterPath;
import static thecastertamamomod.BasicMod.makeID;

public class CasterTamamo extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Caster"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass THE_CASTER_TAMAMO;
        @SpireEnum(name = "THE_CASTER_TAMAMO") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "THE_CASTER_TAMAMO") @SuppressWarnings("unused")
        ...
        private static final Color cardColor = new Color(164f/255f, 75f/255f, 98f/255f, 1f);
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new CasterTamamo(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public CasterTamamo() {
        super(getNames()[0], Meta.THE_CASTER_TAMAMO,
                new CustomEnergyOrb(orbTextures, characterPath("energyorb/vfx.png"), layerSpeeds), //Energy Orb
                //todo make tamamo's mirror her orb.
                //alice you had an idea that you could extend the customenergyorb class and change the required dimensions of the orb png
                /* new SpriterAnimation(characterPath("animation/default.scml"))); //Animation */
                //todo animate tamamo. long term goal.
                new AbstractAnimation() { //No Animation
                    @Override
                    public Type type() {
        ...
        this.masterDeck = new CustomCardGroup(CardGroup.CardGroupType.MASTER_DECK);

        initializeClass(characterPath("staticcharacter.png"),
                SHOULDER_2,
                SHOULDER_1,
                CORPSE,
                getLoadout(),
                20.0F, 0.0F, 200.0F, 250.0F, //Character hitbox. x y position, then width and height.
                new EnergyManager(ENERGY_PER_TURN));

        //Location for text bubbles. You can adjust it as necessary later. For most characters, these values are fine.
        dialogX = (drawX + 25.0F * Settings.scale);
        dialogY = (drawY + 200.0F * Settings.scale);
    }

    @Override
    public void applyStartOfCombatLogic() {
        super.applyStartOfCombatLogic();
        addPower(new ManaPower(this, 10, 10));
    }
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Defend.ID);
        retVal.add(Defend.ID);
        retVal.add(CasterComboCard.ID);
        retVal.add(MyRoom.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(TamamoStartingRelic.ID);
