...
public class TheFieldsOfNasu extends ManaCard {
    public static final String ID = makeID("TheFieldsOfNasu"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public TheFieldsOfNasu() {
        super(ID, info); //Pass the required information to the BaseCard constructor.

    }

    public void useManaCard(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new TheFieldsOfNasuPower(p, 1)));
