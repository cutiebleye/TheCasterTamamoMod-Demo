...
public class ArtsBoostCard extends BaseCard {
    public static final String ID = makeID("ArtsBoost"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public ArtsBoostCard() {
        super(ID, info); //Pass the required information to the BaseCard constructor.
    }

    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new ArtsBoostPower(p, 1)));
    }
