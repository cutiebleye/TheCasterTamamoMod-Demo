...
public class ChaosHeaven extends ManaCard {
    ...
    public static final String ID = makeID("ChaosHeaven"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    protected void useManaCard(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ChaosHeavenAction(this.magicNumber, m));
    }
