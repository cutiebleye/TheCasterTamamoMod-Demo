...
public class SunlitDroplet extends ManaCard {
    public static final String ID = makeID("SunlitDroplet"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
