...
public class RefreshingDrink extends ManaCard {

    public static final String ID = makeID("RefreshingDrink"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
