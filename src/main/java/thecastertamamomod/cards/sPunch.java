...
public class sPunch extends BaseCard {
    public static final String ID = makeID("sPunch"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
