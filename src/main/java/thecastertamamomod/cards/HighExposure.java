...
public class HighExposure extends ManaCard {

    public static final String ID = makeID("HighExposure"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static int cardsToDraw = 0;
    ...
    protected void useManaCard(AbstractPlayer p, AbstractMonster m) {
        ...
        System.out.println("I am drawing " + magicNumber);
