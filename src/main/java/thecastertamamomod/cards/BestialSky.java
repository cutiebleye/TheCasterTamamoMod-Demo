...
public class BestialSky extends ManaCard {

    public static final String ID = makeID("BestialSky"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    protected void useManaCard(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new LoseArtsPower(p, this.magicNumber), this.magicNumber));
    }
}
