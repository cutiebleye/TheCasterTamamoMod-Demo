...
public class Piggyback extends ManaCard {

    public static final String ID = makeID("Piggyback"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
