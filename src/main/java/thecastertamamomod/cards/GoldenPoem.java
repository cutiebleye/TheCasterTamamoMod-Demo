...
public class GoldenPoem extends ManaCard {

    public static final String ID = makeID("GoldenPoem"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    private static final int UPG_MANA_GAIN = 5;
