...
public class AphoticCave extends ManaCard {

    public static final String ID = makeID("AphoticCave"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    protected void useManaCard(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new ApplyPowerAction(p, p, new AphoticCavePower(p, 1), 1));
    }
}
