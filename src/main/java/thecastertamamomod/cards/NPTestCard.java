...
public class NPTestCard extends BaseCard {
    public static final String ID = makeID("NPTestCard"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new CasterNPPower(p, 1)));
    }
