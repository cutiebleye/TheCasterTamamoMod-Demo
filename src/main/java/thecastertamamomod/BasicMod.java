package thecastertamamomod;

import basemod.AutoAdd;
import basemod.BaseMod;
import basemod.interfaces.*;
import com.megacrit.cardcrawl.unlock.UnlockTracker;
import thecastertamamomod.cards.BaseCard;
import thecastertamamomod.character.CasterTamamo;
import thecastertamamomod.relics.BaseRelic;
import thecastertamamomod.util.GeneralUtils;
import thecastertamamomod.util.KeywordInfo;
import thecastertamamomod.util.TextureLoader;
...
import thecastertamamomod.variables.ManaCostVariable;
import thecastertamamomod.variables.ManaGainVariable;
...
public class BasicMod implements
    ...
    public static void initialize() {
        ...
        new BasicMod();
        CasterTamamo.Meta.registerColor();
    }
    ...
    public void receiveEditCharacters() {
        CasterTamamo.Meta.registerCharacter();
    }

    @Override
    public void receiveEditCards() { //somewhere in the class
        BaseMod.addDynamicVariable(new ManaCostVariable());
        BaseMod.addDynamicVariable(new ManaGainVariable());
